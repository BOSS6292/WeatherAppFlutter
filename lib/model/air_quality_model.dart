class AirQuality {
  ...
  AirQuality.fromJson(Map<String, dynamic> json) {
    ...
    if (json['list'] != null) {
      list = <AirQualityList>[];
      json['list'].forEach((v) {
        list!.add(AirQualityList.fromJson(v));
      });
    }
  }
...
class AirQualityList {
  ...
  AirQualityList({this.main, this.components, this.dt});

  AirQualityList.fromJson(Map<String, dynamic> json) {
